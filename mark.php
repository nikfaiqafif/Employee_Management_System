...
$sql = "SELECT pid, project.eid, project.pname, project.duedate, project.subdate, project.mark, rank.points, employee.firstName, employee.lastName, salary.base, salary.bonus, salary.total FROM `project` , `rank` ,`employee`, `salary` WHERE 'project.eid'= '$id' AND 'project.pid' = '$pid'";
...
<title>Project Mark | Seguro</title>
...
id="textField" value="<?php echo $id;?>" required="required">
